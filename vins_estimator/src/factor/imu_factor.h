...
//delta_q = Qi.inverse() * Qj;
        ...
        Vector3d residual_P ={residual(0,0),residual(1,0),residual(2,0)};
        //printf("imu residual P is:%f,%f,%f\n",residual(0,0),residual(1,0),residual(2,0));
        IMU_bias +=residual_P.squaredNorm();
        if (jacobians)
        {
