...
public:
	KeyFrame(double _time_stamp, int _index, Vector3d &_vio_T_w_i, Matrix3d &_vio_R_w_i, cv::Mat &_image,
			 ...
			 vector<double> &_point_id, int _sequence , string lable_,string lable_op_,Vector3d &Velocity_,Vector3d &Acc,Vector3d &Gyc);
	...
	void getVelocity(Eigen::Vector3d &_V_i);
	void getIMU(Eigen::Vector3d &_A_i,Eigen::Vector3d &_G_i);
	void updatePose(const Eigen::Vector3d &_T_w_i, const Eigen::Matrix3d &_R_w_i);
	void updateVioPose(const Eigen::Vector3d &_T_w_i, const Eigen::Matrix3d &_R_w_i);
	void updateLoop(Eigen::Matrix<double, 8, 1 > &_loop_info);
	void updateVelocity(Eigen::Vector3d &_V_i);
	void updateAcc(Eigen::Vector3d &_A_i);
	...
	//add
	string Spline_frame_;
	string Spline_op_frame_;
