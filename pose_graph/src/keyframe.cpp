...
KeyFrame::KeyFrame(double _time_stamp, int _index, Vector3d &_vio_T_w_i, Matrix3d &_vio_R_w_i, cv::Mat &_image,
		           ...
		           vector<double> &_point_id, int _sequence,std::string lable_,std::string op_lable_,Vector3d &Velovity_,Vector3d &Acc_,Vector3d &Gyc_)
{
	Velocity = Velovity_;//add
	Acc = Acc_;//add
	Gyc = Gyc_;//add
	...
	sequence = _sequence;
	Spline_frame_ = lable_;
	Spline_op_frame_ = op_lable_;
...
void KeyFrame::getVelocity(Eigen::Vector3d &_V_i)
{
	_V_i = Velocity;
};

void KeyFrame::updateVelocity(Eigen::Vector3d &_V_i)
{
	Velocity=_V_i;
};

void KeyFrame::getIMU(Eigen::Vector3d &_A_i,Eigen::Vector3d &_G_i)
{
	_A_i = Acc;
	_G_i = Gyc;
};

void KeyFrame::updateAcc(Eigen::Vector3d &_A_i)
{
	Acc=_A_i;
};
